...
@Component({
  ...
  styleUrl: './manufacturers-table.component.scss'
})
export class ManufacturersTableComponent implements AfterViewInit {
  @ViewChild(MatPaginator) paginator!: MatPaginator;
  @ViewChild(MatSort) sort!: MatSort;
  @ViewChild(MatTable) table!: MatTable<ManufacturerEntity>;
  private data: ManufacturerEntity[] = [];
  ...
  dataSource = new MatTableDataSource<ManufacturerEntity>([]);

  /** Columns displayed in the table. Columns IDs can be added, removed, or reordered. */
  displayedColumns = ['nome', 'cnpj', 'endereco', 'actions'];
